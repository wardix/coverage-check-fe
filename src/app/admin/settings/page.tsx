...
import { apiService, Salesman } from "@/services/api";
...
export default function AdminSettingsPage() {
  ...
  const addSalesman = async () => {
    if (
      ...
      !dialogForm.employee_id.trim() ||
      !dialogForm.branch_id.trim()
    ) {
      toast.error("Please fill in all salesman fields");
      return;
    }
    ...
    try {
      ...
      const response = await axios.post<ApiResponse>(
        `${API_URL}/salesman`,
        {
          ...
          employee_id: dialogForm.employee_id,
      ...
      if (response.data.success) {
        ...
        setDialogForm({ name: "", employee_id: "", branch_id: "" });
      ...
      {isDialogOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-md p-6">
            <h2 className="text-lg font-semibold mb-4">Add New Salesman</h2>
